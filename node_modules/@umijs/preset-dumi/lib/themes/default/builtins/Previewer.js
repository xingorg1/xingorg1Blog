...
var Previewer = /*#__PURE__*/function (_Component) {
    ...
    _this.initCSBData = function () {
      ...
      var CSBData = {
        files: _objectSpread((_objectSpread2 = {
          ...
          content: "import React from 'react';\nimport ReactDOM from 'react-dom';\n".concat(dependencies.antd ? "import 'antd/dist/antd.css';" : '', "\nimport App from './demo';\n\n").concat(_codesandbox.issueLink)
        }), _objectSpread2), files),
        deps: _objectSpread({}, dependencies, {
          react: '^16.8.0'
        }),
  ...
  _createClass(Previewer, [{
    ...
    value: function componentDidMount() {
      ...
      this.initCSBData(); // prioritize display tsx
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
      ...
      }, !hasExternalFile && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_csbButton.default, {
        ...
        value: JSON.stringify({
          ...
          css: dependencies.antd ? "@import 'antd".concat("@".concat(dependencies.antd), "/dist/antd.css';") : ''
        })
