...
var _default = (routes, opts, userCustomNavs) => {
  ...
  routes.forEach(route => {
    ...
    if ((_route$meta = route.meta) === null || _route$meta === void 0 ? void 0 : _route$meta.nav) {
      ...
      localeNavs[locale] = _objectSpread({}, localeNavs[locale] || {}, {
        [navPath]: _objectSpread({}, ((_localeNavs$locale = localeNavs[locale]) === null || _localeNavs$locale === void 0 ? void 0 : _localeNavs$locale[navPath]) || {}, {}, route.meta.nav || {}, {
          path: navPath
        })
      });
    }
