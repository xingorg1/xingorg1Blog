...
var _default = (api, opts) => {
  ...
  config.push({
    path: '/',
    component: (0, _slash().default)(_path().default.relative(paths.absPagesPath, _path().default.join(__dirname, '../themes/default/layout.js'))),
  ...
  config[0].routes.forEach(route => {
    ...
    if ((_route$meta = route.meta) === null || _route$meta === void 0 ? void 0 : _route$meta.example) {
      ...
      route.component = _path().default.relative(paths.absPagesPath, _path().default.join(__dirname, '../themes/default/builtins/Example.js'));
