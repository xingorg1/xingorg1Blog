    ...
    if (menuItem.children) {
      menuItem.children = menu.children.map(child => {
        ...
        if (typeof child === 'string') {
          ...
          route.meta.group = _objectSpread({
            title: menu.title
          }, menu.path ? {
            path: menu.path
...
function getMenuFromRoutes(routes, opts, paths) {
  ...
  routes.forEach(route => {
    if (isValidMenuRoutes(route)) {
      ...
      if (group === null || group === void 0 ? void 0 : group.path) {
        ...
        localeMenusMapping[locale] = _objectSpread({}, localeMenusMapping[locale] || {}, {
          [nav]: _objectSpread({}, ((_localeMenusMapping$l8 = localeMenusMapping[locale]) === null || _localeMenusMapping$l8 === void 0 ? void 0 : _localeMenusMapping$l8[nav]) || {}, {
  ...
  Object.keys(localeMenusMapping).forEach(locale => {
    Object.keys(localeMenusMapping[locale]).forEach(nav => {
      ...
      if (menus.length) {
        localeMenus[locale] = _objectSpread({}, localeMenus[locale] || {}, {
